...
public class QueryHandler {
    public static <T extends Class> List<T> createQuery(T entity) {
    ...
    public static <T extends Class> List<T> createQuery(T entity, Map<String, String> fields) {
        ClassDataExtracted data = ClassDataExtract.extract(entity);
    ...
    private static <T extends Class> List<T> executeQuery(String query, T entity) {
